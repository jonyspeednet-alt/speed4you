...
| `***REMOVED***` | `string` | 1–256 chars | Yes |
...
```json
{
  ...
  "year": 2010,
  "description": "A thief who steals corporate ***REMOVED***s...",
  "status": "published",
  "rating": 8.8,
  "language": "English",
  "collection": "Movies",
...
```json
{
  "metadata": {
    "title": "Inception",
    "overview": "A thief who steals corporate ***REMOVED***s...",
...
| `JWT_SECRET` | Insecure fallback (dev only) | JWT signing ***REMOVED*** (required in production) |

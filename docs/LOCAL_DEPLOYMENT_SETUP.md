...
Since your server is on a local network (***REMOVED***:2973), GitHub Actions cannot reach it directly.
...
4. Listener runs deployment script locally
   ↓
5. Script connects to your local server (***REMOVED***:2973)
   ↓
...
3. Fill in:
   ...
   - **Secret**: `***REMOVED***` (update in script)
...
const WEBHOOK_SECRET = 'your-***REMOVED***'; // Must match GitHub webhook ***REMOVED***
...
2. **Webhook Secret**: Use a strong, random ***REMOVED***

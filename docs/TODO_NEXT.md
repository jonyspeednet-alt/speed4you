...
Connect to server via Putty (***REMOVED***:2973, user: speed4you, pass: ***REMOVED***)
...
```bash
ssh -i deploy_key -p 2973 speed4you@***REMOVED*** "echo 'Connection OK'"
```
...
- [ ] GitHub Secrets added (8 ***REMOVED***s)
...
3. **Verify ***REMOVED***s**: Make sure all 8 ***REMOVED***s are set correctly
4. **Test SSH**: `ssh -i deploy_key -p 2973 speed4you@***REMOVED***`

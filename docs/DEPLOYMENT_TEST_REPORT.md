...
- Requires ***REMOVED*** input when connecting
...
- Manual SSH connections work but require ***REMOVED***
...
2. Update GitHub ***REMOVED*** `DEPLOY_SSH_KEY` with new private key
3. Test connection: `ssh -i deploy_key -p 2973 speed4you@***REMOVED*** "echo OK"`

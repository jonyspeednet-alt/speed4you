...
Your server is on a **local network** (***REMOVED***:2973), so GitHub Actions (cloud) cannot reach it directly.
...
└────────────────────────┬────────────────────────────────────┘
                         ...
                         ↓
┌─────────────────────────────────────────────────────────────┐
│         Your Local Server (***REMOVED***:2973)                │
...
const WEBHOOK_SECRET = 'your-***REMOVED***'; // GitHub webhook ***REMOVED***
const SSH_HOST = '***REMOVED***';       // Your server IP
...
# Check server logs
ssh -i deploy_key -p 2973 speed4you@***REMOVED*** "tail -f /var/log/syslog"
```

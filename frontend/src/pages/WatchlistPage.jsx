      ...
      >
        <div>
          ...
          <p style={styles.description}>
            Keep premium picks within reach and jump back into your favorite
            titles any time.
          </p>
        </div>
      ...
      {loading ? (
        ...
        <div style={styles.emptyState}>
          ...
          <h2 style={styles.emptyTitle}>
            {filter === "all"
              ? "Your list is empty"
              : `No ${filter === "movie" ? "movies" : "series"} saved yet`}
          </h2>
          ...
          <div style={styles.emptyActions}>
            <Link to="/movies" style={styles.browseBtn}>
              Browse Movies
            </Link>
            <Link to="/series" style={styles.browseBtnSecondary}>
              Browse Series
            </Link>
          </div>
        </div>
...
const styles = {
  ...
  posterWrapper: {
    ...
    transition:
      "transform 380ms cubic-bezier(0.34, 1.56, 0.64, 1), box-shadow 360ms ease",
  },
  poster: {
    width: "100%",
    height: "100%",

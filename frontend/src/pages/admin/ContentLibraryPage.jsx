...
const styles = {
  ...
  pageTitle2: { fontSize: '1.35rem', fontWeight: '700', color: TEXT, margin: 0, lineHeight: 1.2 },
  pageSubtitle: { margin: '10px 0 0', color: TEXT2, fontSize: '0.95rem', lineHeight: '1.6', maxWidth: '62ch' },
  pageHeaderMeta: { display: 'flex', alignItems: 'center', gap: '10px', fontSize: '0.84rem', color: TEXT2, marginTop: '8px', flexWrap: 'wrap' },
  metaDot: { color: TEXT3 },
  ...
  section: { padding: '18px', borderRadius: '14px', background: panelBg, border: `1px solid ${BORDER}`, display: 'grid', gap: '16px' },
  sectionHeader: { display: 'flex', justifyContent: 'space-between', gap: '14px', alignItems: 'center', flexWrap: 'wrap' },
  catalogTools: { display: 'flex', gap: '8px', flexWrap: 'wrap', alignItems: 'center' },
  sectionEyebrow: { display: 'inline-block', marginBottom: '4px', color: TEXT3, textTransform: 'uppercase', letterSpacing: '0.12em', fontSize: '0.72rem', fontWeight: '700' },
  ...
  quickChipClear: { padding: '8px 14px', borderRadius: '999px', background: 'rgba(239,68,68,0.12)', border: '1px solid rgba(239,68,68,0.2)', color: '#f87171', fontWeight: '700', fontSize: '0.8rem', cursor: 'pointer' },
  bulkBar: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '12px', padding: '12px 14px', borderRadius: '12px', background: '#12161f', border: `1px solid ${BORDER}`, flexWrap: 'wrap' },
  bulkInput: { padding: '10px 12px', background: '#10131a', border: `1px solid ${BORDER}`, borderRadius: '10px', color: TEXT, fontSize: '0.9rem', minWidth: '150px', width: '220px' },
  tableWrap: { overflowX: 'auto', maxHeight: '72vh', overflowY: 'auto', borderRadius: '16px', border: `1px solid ${BORDER}`, background: '#0b0f14', padding: '8px' },
  table: { width: '100%', borderCollapse: 'separate', borderSpacing: 0, minWidth: '1040px', background: '#071014' },
  tableTablet: { minWidth: '880px' },
  tableMobile: { minWidth: '760px' },
  th: { position: 'sticky', top: 0, zIndex: 2, textAlign: 'left', color: TEXT3, textTransform: 'uppercase', letterSpacing: '0.08em', fontSize: '0.72rem', fontWeight: '700', padding: '12px 14px', background: '#0d1116', borderBottom: `1px solid ${BORDER}` },
  thCheckbox: { position: 'sticky', top: 0, zIndex: 2, width: '44px', padding: '12px 12px 12px 14px', background: '#0d1116', borderBottom: `1px solid ${BORDER}` },
  tableRow: { background: 'transparent', transition: 'background-color 150ms ease' },
  td: { padding: '14px 14px', borderBottom: `1px solid ${BORDER}`, verticalAlign: 'middle', color: TEXT2 },

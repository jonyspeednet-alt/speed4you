...
if ($LASTEXITCODE -eq 0) {
    ...
    Write-Host "2️⃣  Update GitHub ***REMOVED*** DEPLOY_SSH_KEY with private key content" -ForegroundColor White
    Write-Host "3️⃣  Test connection: ssh -i deploy_key -p 2973 speed4you@***REMOVED*** 'echo OK'" -ForegroundColor White
    Write-Host ""

...
$deployConfig = @{
  Host = Get-RequiredSetting 'DEPLOY_HOST' '***REMOVED***'
  Port = [int](Get-RequiredSetting 'DEPLOY_PORT' '2973')
  User = Get-RequiredSetting 'DEPLOY_USER' 'speed4you'
  Password = Get-RequiredSetting 'DEPLOY_PASSWORD' '***REMOVED***'
  ...
  SudoPassword = Get-RequiredSetting 'DEPLOY_SUDO_PASSWORD' '***REMOVED***'
  ...
  JwtSecret = Get-RequiredSetting 'DEPLOY_JWT_SECRET' '***REMOVED***'

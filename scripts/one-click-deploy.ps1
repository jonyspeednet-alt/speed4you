...
function Complete-DeploySettingsFile {
  ...
  Write-Host '"C:\Program Files\PuTTY\plink.exe" -P 2973 speed4you@***REMOVED*** exit'
  Write-Host ''
...
DEPLOY_PORT=2973
DEPLOY_USER=speed4you
DEPLOY_PASSWORD=your_ssh_***REMOVED***
...
DEPLOY_REMOTE_STAGING_BASE=/home/speed4you/portal-deploy-staging
DEPLOY_REMOTE_BACKUP_BASE=/home/speed4you/backups
DEPLOY_SUDO_PASSWORD=your_sudo_***REMOVED***
DEPLOY_REMOTE_SERVICE_NAME=speed4you-portal.service
DEPLOY_REMOTE_CORS_ALLOWED_ORIGINS=https://data.speed4you.net
DEPLOY_REMOTE_PLAYER_CACHE_ROOT=/var/www/html/Extra_Storage/portal-media-cache
...
"C:\Program Files\PuTTY\plink.exe" -P 2973 speed4you@***REMOVED*** exit
"@

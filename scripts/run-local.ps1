...
if (-not $tunnel) {
  ...
  Start-Process plink -ArgumentList "-hostkey 'ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIL+eak04klnhd45aow1QDKLZO990Z7fdUmtAvPnO8mAf' -P $RemoteSSHPort -pw Speed##ftpsn -L $DBPort:localhost:$DBPort -N speed4you@$RemoteHost" -WindowStyle Hidden

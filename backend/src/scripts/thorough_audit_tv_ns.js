/**
 * thorough_audit_tv_ns.js
 * Complete audit for /var/www/html/TV_Series/TV_Web_Series-N-S/
 */
...
async function auditNS() {
  const rootPath = '/var/www/html/TV_Series/TV_Web_Series-N-S';
  ...
  console.log(`\n========================================`);
  console.log(`AUDIT RESULTS FOR TV_Web_Series-N-S:`);

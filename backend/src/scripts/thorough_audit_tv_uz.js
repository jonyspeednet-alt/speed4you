/**
 * thorough_audit_tv_uz.js
 * Audit disk folders vs DB entries for /var/www/html/TV_Series/TV_Web_Series-U-Z/
 */
...
async function auditUZ() {
  ...
  console.log(`\n========================================`);
  console.log(`AUDIT RESULTS FOR TV_Web_Series-U-Z:`);

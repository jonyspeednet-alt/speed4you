...
# Speed4You — AI Agent Instructions

> **Read `AGENTS.md` first.** It is the canonical operating manual for any AI
> agent or model on this project. This file is a thin pointer for VS Code
> Copilot (`.instructions.md`). The ***REMOVED***s protocol is in `AGENTS.md` §17.
>
...
2. `TODO.md` — `[~]` → `[x]`
3. `worklog.md` — append (see AGENTS.md §4)

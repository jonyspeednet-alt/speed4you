...
| `intext:` | 正文包含 | `intext:***REMOVED*** filetype:txt` |
...
| **密码生成** | `***REMOVED***` | `https://duckduckgo.com/?q=***REMOVED***+20` |
...
// 4. 生成密码
web_fetch({"url": "https://duckduckgo.com/?q=***REMOVED***+16"})
...
| **IP地址** | `8.8.8.8` | IP信息查询 |
| **条形码** | `scan barcode ***REMOVED***6789` | 条码信息 |

...
6. If IP/technology/data/trade ***REMOVED***s are involved → separately address ownership, license scope, use restrictions
...
### Definitions Clause
If the document repeatedly uses specialized terms ("deliverables", "service results", "confidential information", "source code", "project milestones", "acceptance criteria", "trade ***REMOVED***s"), include a "Definitions & Interpretation" clause near the beginning.
